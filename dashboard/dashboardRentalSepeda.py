...
# PREPARE FILTER
jam_df=pd.read_csv('D:\TugasProyekDicodingAnalisisData\dashboard/new_jam.csv')
...
with kolom41:
    fig = px.line(perjam,
              ...
              color_discrete_sequence=["blue", "green", "red"],
              markers=True,
              title="Jumlah perental tiap jam").update_layout(xaxis_title='', yaxis_title='Total Rides')
...
with kolom42:
    fig = px.line(perhari,
              ...
              color_discrete_sequence=["blue", "green", "red"],
              markers=True,
              title="Jumlah perental tiap hari").update_layout(xaxis_title='', yaxis_title='Total Rides')
